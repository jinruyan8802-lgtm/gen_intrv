...
class Config:
    ...
    tts_provider: str  # "openai", "minimax", "edge", "mimo", "cosyvoice"
    tts_model: str     # e.g. "speech-01-hd" for minimax, "CosyVoice-300M-SFT" for cosyvoice
    language: str
    question_count: int
    tts_concurrency: int
    dedup_tfidf_threshold: float
    cosyvoice_root: str
    cosyvoice_conda_env: str
    ...
    def from_env(cls, env_path: str = ".env") -> "Config":
        ...
        tts_provider = os.getenv("TTS_PROVIDER", "openai")  # "openai", "minimax", "edge", "mimo", "cosyvoice"
        ...
        cosyvoice_conda_env = os.getenv("COSYVOICE_CONDA_ENV", "cosyvoice")
